...
class CConstants 
{
     ...
     public static $numberlenghty ="Phone Number is incorrect!";               
     public static $loginfailed = "ENTER VALID USERNAME AND PASSWORD";
     public static $usernameempty = "PLEASE ENTER USERNAME";
     public static $passwordempty = "PLEASE ENTER PASSWORD";
     public static $passwordvalid = "PLEASE ENTER VALID PASSWORD";
     public static $usernamevalid = "PLEASE ENTER VALID USERNAME";
}	
?>